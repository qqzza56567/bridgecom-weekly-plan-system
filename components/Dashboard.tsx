  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-[#eef5ff]">
      ...
      <div className="mb-8 text-center">
        <div className="bg-gray-200 px-6 py-3 inline-block rounded-sm mb-4 border border-gray-300">
             <span className="text-blue-700 font-bold tracking-widest text-lg">{COMPANY_NAME}</span>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-5xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <button
                ...
                className={`h-24 border rounded-lg transition font-medium text-lg shadow-sm ${
                    user.isManager 
